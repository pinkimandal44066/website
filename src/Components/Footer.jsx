...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-black via-white to-black mt-20 relative">
      {/* Waves */}
      <div className="waves absolute w-full">
        <div className="wave" id="wave1"></div>
        <div className="wave" id="wave2"></div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-10">
          ...
          <div className="col-span-1 lg:mx-16 w-full">
            ...
            <ul className="text-sm">
              ...
              <li>
                <NavLink to="/refundreturnpolicy">Refund/Return Policy</NavLink>
              </li>
              <li>
              ...
              {/* Uncomment below for Contact Us link */}
              {/* <li>
                <a href="#">Contact us</a>
              </li> */}
            </ul>
