...
//   return (
//     <footer
//       className="bg-gradient-to-b from-black via-white to-black mt-20 relative overflow-hidden"
//     >
//       {/* Waves */}
//       <div className="waves absolute w-full bottom-0">
//         <div className="wave" id="wave1"></div>
//         <div className="wave" id="wave2"></div>
//         <div className="wave" id="wave3"></div>
//         <div className="wave" id="wave4"></div>
...
const Footer = () => {
  return (
    <footer
      className="bg-gradient-to-b from-black via-white to-black  mt-10 relative overflow-hidden"
    >
      {/* Waves */}
      <div className="waves absolute bottom-0 left-0 w-full">
        <div className="wave" id="wave1"></div>
        <div className="wave" id="wave2"></div>
        <div className="wave" id="wave3"></div>
        <div className="wave" id="wave4"></div>
