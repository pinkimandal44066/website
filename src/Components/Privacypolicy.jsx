        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-center px-6 py-12 sm:py-20">
          <div className="text-center sm:text-left sm:w-1/2">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white mt-4">
              At SystAIO, we are committed to protecting your privacy. This
              Privacy Policy outlines the types of information we collect and
              how we use, disclose, and safeguard your information. We
              prioritize the safety and confidentiality of our clients' data.
            </p>
          </div>
      ...
      <div className=" flex flex-col max-w-screen-xl lg:mx-auto mx-5 ">
        <main className=" w-full p-3 mt-10">
          <p>
            ...
            “SystAIO”, or “we”, or “us ) uses and protects any information that
            you give Systaio Tehnologies when you use this website.
          </p>

          <p className="mt-5">
            Systaio Tehnologies is committed to ensuring that your privacy is
            ...
            statement. Systaio Tehnologies may change this policy from time to
          ...
          <p>
            ...
            last name, email address, a home, postal or other physical address,
            other contact information, title, occupation, industry, personal
            interests, and other information when needed to provide a service or
            product or carry out a transaction you have requested.
          </p>

          <h2 className="text-xl font- mt-10">
          ...
          <div>
            <p className="mb-10 mt-10 text-base">
              systaio may also send your personal information to other companies
              or people if:
              <p>systaio have users’ consent to share the information;</p>
              <p>
                systaio may share User’s personally identifiable information
                with our resellers and partners, so that such resellers and
                partners may use such information to market systaio‘s products
                and services, and to market their own products and services.
                Systaio may engage certain trusted third parties to perform
                function and provide services to us, including without
                limitation, hosting and management services, customer
                relationship services, database storage and management services,
                fulfilling orders, sending email, processing credit card
                payments or other functions necessary to our business; and
                systaio may share your personally identifiable information with
                these third parties, but only to the extent necessary to perform
                these functions and provide such services, and only pursuant to
                binding contractual obligations requiring such third parties to
                maintain confidentiality of your data.
              </p>
            </p>

            <p className="mb-10">
              Systaio Tehnologies may also reveal a user’s identity or relevant
              information if systaio knows or believes that User is harming or
              interfering with other our users, anyone else, or violating the
              Agreement or infringing any of the systaio ‘s legal rights.
              Systaio Tehnologies may also reveal user’s personal information
              when required to do so by law, or if we have a good-faith belief
              that such action is necessary to comply with a court order or
              subpoena, to cooperate with investigations by law enforcement or
              regulatory authorities or to participate or cooperate with a
              judicial proceeding, or in urgent circumstances, to protect
              personal safety, the public or our websites; to protect the
              property and rights of systaio or a third party, the safety of the
              public or any person; to prevent or stop any illegal, unethical or
              legally actionable activity.
            </p>

            <p className="mb-10">
              In the event of a merger, consolidation or reorganization
              involving systaio , acquisition of systaio by another company, or
              other similar transaction, your personal information will, in most
              instances, be transferred to the control of the third party that
              is part of that transaction.
            </p>

            <p className="mb-5" style={{ fontFamily: "PTSerif-Bold" }}>
              Security.
            </p>
            ...
            <p className="mb-10">
              ...
              statement applicable to the website in question. Controlling your
              ...
              <p>
                ...
                third parties which we think you may find interesting if you
                tell us that you wish this to happen. You may request details of
                personal information which we hold about you as governed by the
                laws of India. A small fee may be payable. If you would like a
                copy of the information held on you please write to us on our
                mail. If you believe that any information we are holding on you
                is incorrect or incomplete, please write to or email us as soon
